...
LEGACY_SCALAR_CHANNELS = [
    ...
    ChannelSpec("rf_readback_499mhz", "MCLKHGP:rdFrq499", "scalar", notes="Observed 499 MHz RF readback channel from the control-room scope panel.", tags=("rf",)),
    ...
    ChannelSpec("beam_current_scope", "mlsCurrent:Mnt3collectData.VALD", "scalar", notes="Beam current/collection data channel seen in the control-room scope panel.", tags=("beam", "diagnostics")),
    ChannelSpec("p1_h1_ampl", "SCOPE1ZULP:h1p1:rdAmpl", "scalar", notes="Live P1 harmonic amplitude monitor from the control-room scope panel.", tags=("ssmb_light", "p1")),
    ChannelSpec("p1_h1_ampl_avg", "SCOPE1ZULP:h1p1:rdAmplAv", "scalar", notes="Average P1 harmonic amplitude monitor from the control-room scope panel.", tags=("ssmb_light", "p1", "average")),
    ChannelSpec("p1_h1_ampl_dev", "SCOPE1ZULP:h1p1:rdAmplDev", "scalar", notes="Standard deviation of P1 harmonic amplitude from the control-room scope panel.", tags=("ssmb_light", "p1", "statistics")),
    ChannelSpec("p3_h1_ampl", "SCOPE1ZULP:h1p3:rdAmpl", "scalar", notes="Live P3 harmonic amplitude monitor from the control-room scope panel.", tags=("ssmb_light", "p3")),
    ChannelSpec("p3_h1_ampl_avg", "SCOPE1ZULP:h1p3:rdAmplAv", "scalar", notes="Average P3 harmonic amplitude monitor from the control-room scope panel.", tags=("ssmb_light", "p3", "average")),
    ...
    ChannelSpec("qpd_l2_sigma_y_avg", "QPD01ZL2RP:rdSigmaYav", "scalar", notes="Archived averaged Sigma-Y channel seen in copied control-room scripts for the QPD01 / QPD01ZL2RP synchrotron-radiation camera/profile monitor.", tags=("diagnostics", "u125_region", "average")),
    ChannelSpec("qpd_l2_center_x_avg_um", "QPD01ZL2RP:rdCenterXav", "scalar", notes="Averaged X-center channel seen on the control-room strip-chart panel for the QPD01 / QPD01ZL2RP synchrotron-radiation camera/profile monitor.", tags=("diagnostics", "u125_region", "center")),
    ...
    ChannelSpec("qpd_l4_sigma_y_avg", "QPD00ZL4RP:rdSigmaYav", "scalar", notes="Archived averaged Sigma-Y channel seen in copied control-room scripts for the QPD00 / QPD00ZL4RP synchrotron-radiation camera/profile monitor.", tags=("diagnostics", "l4", "average")),
    ChannelSpec("qpd_l4_center_x_avg_um", "QPD00ZL4RP:rdCenterXav", "scalar", notes="Averaged X-center channel seen on the control-room strip-chart panel for the QPD00 / QPD00ZL4RP synchrotron-radiation camera/profile monitor.", tags=("diagnostics", "l4", "center")),
    ChannelSpec("climate_kw13_return_temp_c", "KLIMAC1CP:coolKW13:rdRetTemp", "scalar", notes="Cooling-water return temperature seen on the control-room strip-chart panel near the SSMB diagnostics.", tags=("temperature", "cooling", "environment")),
    ChannelSpec("climate_sr_temp_c", "KLIMAC1CP:sr:rdTemp", "scalar", notes="SR-area temperature channel seen on the control-room strip-chart panel.", tags=("temperature", "environment", "sr")),
    ChannelSpec("climate_sr_temp1_c", "KLIMAC1CP:sr:rd1Temp", "scalar", notes="Second SR-area temperature channel seen on the control-room strip-chart panel.", tags=("temperature", "environment", "sr")),
