...
class SSMBExperimentGuiImportTest(unittest.TestCase):
    ...
    def test_quick_phase_sweep_preset_sets_rf_scan_defaults(self):
        ...
        self.assertEqual(app.delta_min_hz_var.get(), "-10")
        self.assertEqual(app.delta_max_hz_var.get(), "10")
        self.assertEqual(app.points_var.get(), "9")
        self.assertEqual(app.settle_var.get(), "0.5")
