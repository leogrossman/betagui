""" Module for the MLS storage ring reference lattice. """

import at
import numpy as np
from reflat_tools.lattice import create_lattice

def mls_storage_ring() -> at.Lattice:
    ...
    # 13.10.2025 first order approximation for Standarduser, A. Kruschinski, T. Olsson, M. Ries
    #--------------------------
    ...
    first_half_of_K1 = [\
        ...
        at.Sextupole('S3M2K1RP',0.1,h=VS3P1,Corrector='HV',KickAngle=[0,0]),\
        ...
        at.Sextupole('S2M2K1RP',0.1,h=VS2P1,Corrector='V',KickAngle=[0,0]),\
        at.Drift('D4L2K1RP_1',0.049),\
        at.Monitor('BPMZ7K1RP'),\
        at.Drift('D4L2K1RP_2',0.251),\
        at.Sextupole('S1M2K1RP',0.1,h=VS1P1,Corrector='H',KickAngle=[0,0]),\
    ...
    L2 = [\
        ...
        at.Sextupole('S1M1L2RP',0.1,h=VS1P1,Skew='CQ'),\
        at.Drift('D4L1L2RP',0.3),\
        at.Sextupole('S2M1L2RP',0.1,h=VS2P1,Corrector='V',KickAngle=[0,0]),\
        ...
        at.Sextupole('S3M1L2RP',0.1,h=VS3P1,Corrector='HV',KickAngle=[0,0]),\
        ...
        at.Sextupole('S3M2L2RP',0.1,h=VS3P2,Corrector='HV',KickAngle=[0,0]),\
        ...
        at.Sextupole('S2M2L2RP',0.1,h=VS2P2L,Corrector='V',KickAngle=[0,0]),\
        at.Drift('D4L2L2RP_1',0.049),\
        at.Monitor('BPMZ7L2RP'),\
        at.Drift('D4L2L2RP_2',0.251),\
        at.Sextupole('S1M2L2RP',0.1,h=VS1P2,Skew='CQ'),\
    ...
    K3 = [\
        ...
        at.Sextupole('S1M1K3RP',0.1,h=VS1P2,Corrector='H',KickAngle=[0,0]),\
        at.Drift('D4L1K3RP',0.3),\
        at.Sextupole('S2M1K3RP',0.1,h=VS2P2K,Corrector='V',KickAngle=[0,0]),\
        ...
        at.Sextupole('S3M1K3RP',0.1,h=VS3P2,Corrector='HV',KickAngle=[0,0]),\
        ...
        at.Sextupole('S3M2K3RP',0.1,h=VS3P2,Corrector='HV',KickAngle=[0,0]),\
        ...
        at.Sextupole('S2M2K3RP',0.1,h=VS2P2K,Corrector='V',KickAngle=[0,0]),\
        at.Drift('D4L2K3RP_1',0.049),\
        at.Monitor('BPMZ7K3RP'),\
        at.Drift('D4L2K3RP_2',0.251),\
        at.Sextupole('S1M2K3RP',0.1,h=VS1P2,Corrector='H',KickAngle=[0,0]),\
    ...
    L4 = [\
        ...
        at.Sextupole('S1M1L4RP',0.1,h=VS1P2,Skew='CQ'),\
        at.Drift('D4L1L4RP',0.3),\
        at.Sextupole('S2M1L4RP',0.1,h=VS2P2L,Corrector='V',KickAngle=[0,0]),\
        ...
        at.Sextupole('S3M1L4RP',0.1,h=VS3P2,Corrector='HV',KickAngle=[0,0]),\
        ...
        at.Sextupole('S3M2L4RP',0.1,h=VS3P1,Corrector='HV',KickAngle=[0,0]),\
        ...
        at.Sextupole('S2M2L4RP',0.1,h=VS2P1,Corrector='V',KickAngle=[0,0]),\
        at.Drift('D4L2L4RP_1',0.049),\
        at.Monitor('BPMZ7L4RP'),\
        at.Drift('D4L2L4RP_2',0.251),\
        at.Sextupole('S1M2L4RP',0.1,h=VS1P1,Skew='CQ'),\
    ...
    second_half_of_K1 = [\
        ...
        at.Sextupole('S1M1K1RP',0.1,h=VS1P1,Corrector='H',KickAngle=[0,0]),\
        at.Drift('D4L1K1RP',0.3),\
        at.Sextupole('S2M1K1RP',0.1,h=VS2P1,Corrector='V',KickAngle=[0,0]),\
        ...
        at.Sextupole('S3M1K1RP',0.1,h=VS3P1, Corrector='HV',KickAngle=[0,0]),\
    ...
    # Create the lattice
    ring = create_lattice(ring, name='MLS storage ring', energy=energy)
