...
LEGACY_SCALAR_CHANNELS = [
    ...
    ChannelSpec("qpd_l2_sigma_x", "QPD01ZL2RP:rdSigmaX", "scalar", notes="L2 beam-size proxy.", tags=("diagnostics", "u125_region")),
    ChannelSpec("qpd_l2_sigma_y", "QPD01ZL2RP:rdSigmaY", "scalar", notes="L2 beam-size proxy.", tags=("diagnostics", "u125_region")),
    ChannelSpec("qpd_l4_sigma_x", "QPD00ZL4RP:rdSigmaX", "scalar", notes="L4 beam-size proxy.", tags=("diagnostics", "l4")),
    ChannelSpec("qpd_l4_sigma_y", "QPD00ZL4RP:rdSigmaY", "scalar", notes="L4 beam-size proxy.", tags=("diagnostics", "l4")),
