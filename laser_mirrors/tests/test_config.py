...
class ConfigTests(unittest.TestCase):
    def test_default_scan_mode_is_vertical_only(self) -> None:
        ...
        self.assertEqual(loaded.scan.overlap_m1_span_urad, 189.0)
        self.assertEqual(loaded.scan.overlap_m2_span_urad, 1890.0)
        self.assertEqual(loaded.scan.overlap_m1_span_steps, 100.0)
        self.assertEqual(loaded.scan.overlap_m2_span_steps, 1000.0)
