...
class ConfigTests(unittest.TestCase):
    def test_default_scan_mode_is_vertical_only(self) -> None:
        ...
        self.assertEqual(loaded.scan.overlap_m1_span_urad, 661.5)
        self.assertEqual(loaded.scan.overlap_m2_span_urad, 3402.0)
        self.assertEqual(loaded.scan.overlap_m1_span_steps, 350.0)
        self.assertEqual(loaded.scan.overlap_m2_span_steps, 1800.0)
        self.assertAlmostEqual(loaded.scan.overlap_diagonal_slope, -1.38)
        self.assertEqual(loaded.scan.overlap_plot_axis, "angle")
        self.assertEqual(loaded.scan.overlap_point_min_dwell_s, 2.0)
        self.assertEqual(loaded.scan.overlap_strip_start_extra_dwell_s, 1.25)
