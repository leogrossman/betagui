...
class LaserMirrorApp:
    ...
    def _build_state(self) -> None:
        ...
        self.overlap_point_min_dwell_var = tk.DoubleVar(value=getattr(self.config.scan, "overlap_point_min_dwell_s", 2.0))
    ...
    def _apply_coarse_recovery_defaults(self) -> None:
        ...
        self.overlap_point_min_dwell_var.set(2.0)
